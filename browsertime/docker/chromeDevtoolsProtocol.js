  ...
  async setup() {
    ...
    try {
      ...
      await this.cdpClient.Network.enable({
        maxTotalBufferSize: 100,
        maxResourceBufferSize: 100,
      });
      ...
      if (this.options.chrome.collectPerfLog) {
        ...
        this.cdpClient.Target.attachedToTarget((params) => {
          attached([], params);
        });
        this.cdpClient.Target.receivedMessageFromTarget((params) => {
          receivedMessage([], params);
        });
        this.cdpClient.Target.setAutoAttach({
          autoAttach: true,
